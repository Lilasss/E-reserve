    ...
    return (
        <div className="flex flex-col h-screen p-5 bg-gray-800 w-64 fixed top-0 left-0 z-40 transition-transform duration-300 ease-in-out">
            ...
            <nav className="flex flex-col space-y-4">
                ...
                <Link
                    to="/admin/evenement"
                    className={`flex items-center p-2 text-gray-300 ${location.pathname.startsWith("/admin/evenement") ? "bg-gray-700 text-white" : "hover:bg-gray-700 hover:text-white"} rounded-lg transition-colors`}
                >
