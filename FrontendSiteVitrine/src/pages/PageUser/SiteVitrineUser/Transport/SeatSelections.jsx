...
// COUCOU HARENA , NATAOKO ETO FOTSINY TY NAMORONAKO SEATSELETIONS ANAKIRAY FA ILAY TARY AM CreateTrans TSY NOKITIHAKO
const SeatSelections = ({ formData, prevStep }) => {
